...
static
SZ_RESULT SzReadTime(CSzData *sd, UInt32 numFiles, CFileItem *files, UInt64 type, ISzAlloc * allocTemp)
{
	UInt32 i;
	Byte *boolVector;
	RINOK(SzReadBoolVector2(sd, numFiles, &boolVector, allocTemp->Alloc))
